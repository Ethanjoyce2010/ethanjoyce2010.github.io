    ...
    <section className="section py-14 md:py-20">
      ...
      <FadeIn>
        <div className="relative mb-8">
          ...
          <p className="section-subtitle">Milestones, awards, and events I’m proud of</p>
        </div>
      </FadeIn>

      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {accomplishments.map((item, i) => (
          <FadeIn key={item.id} delay={i * 0.1} className="h-full">
            <AccomplishmentCard
              item={item}
        ...
        <FadeIn delay={accomplishments.length * 0.1} className="h-full">
          <div className="flex h-full min-h-[200px] flex-col justify-between rounded-2xl border border-dashed border-black/10 bg-black/[.02] p-6 dark:border-white/10 dark:bg-white/[.02]">
            <div className="text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">Coming Soon</div>
            <div className="text-sm text-gray-500 dark:text-gray-400">WIP</div>
          </div>
        </FadeIn>
      </div>
