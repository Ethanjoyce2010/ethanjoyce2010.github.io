...
export function AccomplishmentCard({ item, onActivate }: Props) {
  ...
  return (
    <motion.article
      ...
      className="group relative overflow-hidden rounded-xl border border-black/10 bg-black/[.04] p-5 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.04)] hover:bg-black/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/50 dark:border-white/10 dark:bg-white/[.04] dark:shadow-[0_0_0_1px_rgba(255,255,255,0.04)_inset] dark:hover:bg-white/[.06] dark:focus-visible:ring-cyan-400/60"
    ...
    >
      ...
      <div className="mb-3 flex items-start gap-3">
        <div className="rounded-lg bg-cyan-500/10 p-2 text-cyan-700 shadow-[0_0_20px_rgba(34,211,238,.15)] dark:bg-cyan-400/10 dark:text-cyan-300">
